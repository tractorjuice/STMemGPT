...
st.sidebar.markdown("Streamlit, OpenAI, Memgpt, FAISS")
st.sidebar.divider()
...
if prompt := st.chat_input("How can I help with Wardley Mapping?"):
    ...
    with st.chat_message("assistant"):
        ...
        st.sidebar.write("Msg Total Init")
        st.sidebar.write(st.session_state.messages_total_init)
        st.sidebar.write("Msg Total")
        st.sidebar.write(st.session_state.messages_total)
        #st.write("Agent Msg")
        #st.write(st.session_state.agent_messages)
        st.sidebar.write("Pers Msg")
        st.sidebar.write(st.session_state.persistence_all_messages)
